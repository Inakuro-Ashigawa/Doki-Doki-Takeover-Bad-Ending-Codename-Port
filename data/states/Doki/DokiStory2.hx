...
function update(elapsed:Float){
    ...
    //pretty dumb way of doing this but idc
...
function selectThing(){
    if (curSelected == 8 && icons[curSelected][1] && FlxG.save.data.checkAllSongsBeaten)
    {
...
function goToState(){
    ...
    PlayState.loadWeek({name: icons[curSelected][1],id: "week1",sprite: null,chars: [null, null, null],songs: [for (song in weekData[curSelected]) {name: song, hide: false}], difficulties: ['hard']}, "hard");
